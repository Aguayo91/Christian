...
data class SurtidoVentasXR(
    val message: String = "",
    val type :Int = -5,
    val data: List<SurtidoVentasXRList> = listOf()
)
data class SurtidoVentasXRList(
    val id:Int,
    val sMaster: String = "",
...
@Entity()
data class SurtidoVentasXRListEntity(
...
fun SurtidoVentasXRList.toSurtidoVentasXRListEntity(): SurtidoVentasXRListEntity =
    SurtidoVentasXRListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
