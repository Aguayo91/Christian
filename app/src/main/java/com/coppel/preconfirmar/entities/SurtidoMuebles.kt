...
data class SurtidoMuebles(
    val message: String = "",
    val type: Int = -5,
    val data: List<SurtidoMueblesList> = listOf()
)

data class SurtidoMueblesList(
    val id:Int,
    val sMaster: String = "",
...
@Entity()
data class SurtidoMueblesListEntity(
...
fun SurtidoMueblesList.toSurtidoMueblesListEntity(): SurtidoMueblesListEntity =
    SurtidoMueblesListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
