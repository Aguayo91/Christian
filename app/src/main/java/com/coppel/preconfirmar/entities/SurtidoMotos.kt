...
data class SurtidoMotos(
    val message: String = "",
    val type: Int = -5,
    val data: List<SurtidoMotosList> = listOf()
)
data class SurtidoMotosList(
    val id:Int,
    val sMaster: String = "",
...
@Entity()
data class SurtidoMotosListEntity(
...
fun SurtidoMotosList.toSurtidoMotosListEntity(): SurtidoMotosListEntity =
    SurtidoMotosListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
