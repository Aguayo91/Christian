...
data class SurtidoSuministros(
    val message: String = "",
    val type: Int = -5,
    val data: List<SurtidoSuministrosList> = listOf()
)
data class SurtidoSuministrosList(
    val id:Int,
    val sMaster: String = "",
...
@Entity
data class SurtidoSuministrosListEntity(
...
fun SurtidoSuministrosList.toSurtidoSuministrosListEntity(): SurtidoSuministrosListEntity =
    SurtidoSuministrosListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
