...
data class SurtidoMensajeria(
    val message: String = "",
    val type :Int = -5,
    val data: List<SurtidoMensajeriaList> = listOf()

)
data class SurtidoMensajeriaList(
    val id:Int,
    val sMaster: String = "",
...
@Entity
data class SurtidoMensajeriaListEntity(
...
fun SurtidoMensajeriaList.toSurtidoMensajeriaListEntity(): SurtidoMensajeriaListEntity =
    SurtidoMensajeriaListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
