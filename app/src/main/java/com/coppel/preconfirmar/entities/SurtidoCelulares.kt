...
data class SurtidoCelulares(
    val message: String = "",
    val type :Int = -5,
    val data: List<SurtidoCelularesList> = listOf()
)
data class SurtidoCelularesList(
    val id:Int,
    val sMaster: String = "",
...
@Entity()
data class SurtidoCelularesListEntity(
...
fun SurtidoCelularesList.toSurtidoCelularesListEntity(): SurtidoCelularesListEntity =
    SurtidoCelularesListEntity(
        this.id,
        this.sMaster,
        this.sDescripcion,
        this.sSerie,
